    ...
    return (
        <>
            ...
            <div className='container'>
                <h2 className='gl'>{a.cardnorthindia}</h2>
                <hr />
                ...
                <img src="https://img.onmanorama.com/content/dam/mm/en/food/features/images/2022/1/11/north-indian-cuisine.jpg" alt="india" className="img1" />
            </div>
